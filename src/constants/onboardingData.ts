...
export const MUNICIPAL_HUBS: Record<MunicipalityId, MunicipalContactInfo> = {
  helsinki: {
    ...
    descriptionKey: 'hubs.helsinki_desc',
  },
  espoo: {
    id: 'espoo',
    name: 'Espoo',
    ...
    descriptionKey: 'hubs.espoo_desc',
  },
  vantaa: {
    id: 'vantaa',
    name: 'Vantaa',
    ...
    descriptionKey: 'hubs.vantaa_desc',
  },
  tampere: {
    id: 'tampere',
    name: 'Tampere',
    ...
    descriptionKey: 'hubs.tampere_desc',
  },
  turku: {
    id: 'turku',
    name: 'Turku',
    ...
    descriptionKey: 'hubs.turku_desc',
  },
  oulu: {
    id: 'oulu',
    name: 'Oulu',
  ...
  other: {
    ...
    descriptionKey: 'hubs.other_desc',
  },
};
...
export const ONBOARDING_TASKS: OnboardingTask[] = [
  // --- BEFORE ARRIVAL ---
  {
    ...
    priority: 'critical',
    titleKey: 'tasks.residence_permit_migri.title',
    descriptionKey: 'tasks.residence_permit_migri.description',
  ...
  },
  {
    ...
    phase: 'before_arrival',
    priority: 'high',
    titleKey: 'tasks.apostille_documents.title',
    descriptionKey: 'tasks.apostille_documents.description',
  ...
  },
  {
    ...
    phase: 'before_arrival',
    priority: 'high',
    titleKey: 'tasks.temporary_housing.title',
    descriptionKey: 'tasks.temporary_housing.description',
  ...
  // --- FIRST DAYS ---
  {
    ...
    phase: 'first_days',
    priority: 'critical',
    titleKey: 'tasks.migri_eu_registration.title',
    descriptionKey: 'tasks.migri_eu_registration.description',
  ...
  },
  {
    ...
    phase: 'first_days',
    priority: 'critical',
    titleKey: 'tasks.dvv_registration.title',
    descriptionKey: 'tasks.dvv_registration.description',
  ...
  },
  {
    ...
    phase: 'first_days',
    priority: 'critical',
    titleKey: 'tasks.vero_tax_card.title',
    descriptionKey: 'tasks.vero_tax_card.description',
  ...
  },
  {
    ...
    phase: 'first_days',
    priority: 'medium',
    titleKey: 'tasks.local_sim_card.title',
    descriptionKey: 'tasks.local_sim_card.description',
    estimatedDays: '1 day',
  ...
  },
  {
    ...
    phase: 'first_days',
    priority: 'high',
    titleKey: 'tasks.public_transport_app.title',
    descriptionKey: 'tasks.public_transport_app.description',
    estimatedDays: '1 day',
    officialLinks: [
  ...
  // --- FIRST MONTH ---
  {
    ...
    phase: 'first_month',
    priority: 'critical',
    titleKey: 'tasks.bank_account_strong_id.title',
    descriptionKey: 'tasks.bank_account_strong_id.description',
  ...
  },
  {
    ...
    phase: 'first_month',
    priority: 'critical',
    titleKey: 'tasks.kela_social_security.title',
    descriptionKey: 'tasks.kela_social_security.description',
  ...
  },
  {
    ...
    phase: 'first_month',
    priority: 'high',
    titleKey: 'tasks.home_insurance_contract.title',
    descriptionKey: 'tasks.home_insurance_contract.description',
  ...
  },
  {
    ...
    phase: 'first_month',
    priority: 'high',
    titleKey: 'tasks.electricity_contract.title',
    descriptionKey: 'tasks.electricity_contract.description',
  ...
  },
  {
    ...
    phase: 'first_month',
    priority: 'high',
    titleKey: 'tasks.healthcare_center_registration.title',
    descriptionKey: 'tasks.healthcare_center_registration.description',
    estimatedDays: '1-2 days',
    officialLinks: [
  ...
  },
  {
    ...
    phase: 'first_month',
    priority: 'critical',
    titleKey: 'tasks.daycare_application.title',
    descriptionKey: 'tasks.daycare_application.description',
  ...
  },
  {
    ...
    phase: 'first_month',
    priority: 'critical',
    titleKey: 'tasks.school_registration.title',
    descriptionKey: 'tasks.school_registration.description',
    estimatedDays: '1-3 weeks',
  ...
  // --- SETTLED & INTEGRATION ---
  {
    ...
    phase: 'settled',
    priority: 'medium',
    titleKey: 'tasks.integration_plan_te.title',
    descriptionKey: 'tasks.integration_plan_te.description',
  ...
  },
  {
    ...
    phase: 'settled',
    priority: 'high',
    titleKey: 'tasks.finnish_language_course.title',
    descriptionKey: 'tasks.finnish_language_course.description',
  ...
  },
  {
    ...
    phase: 'settled',
    priority: 'optional',
    titleKey: 'tasks.library_card.title',
    descriptionKey: 'tasks.library_card.description',
    estimatedDays: '1 day',
  ...
  },
  {
    ...
    phase: 'settled',
    priority: 'medium',
    titleKey: 'tasks.driver_license_exchange.title',
    descriptionKey: 'tasks.driver_license_exchange.description',
